...
# Fit at the taxonomy size — "would our actual pipeline have noticed?" 11 named segments under
# waterfall v2 (`Unassigned` is a residual, not a fitted class). The 29 Jul 2026 run used 10, the v1
# named count, so the two runs are comparable in method but not bit-for-bit in k.
K_FIT = 11
