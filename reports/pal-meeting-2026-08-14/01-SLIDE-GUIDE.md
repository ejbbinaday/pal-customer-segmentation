...
**In this pack:** `02-full-study-guide.md` / `.html` (the full detail behind every slide) ·
`figures/` (numbered by slide) · `reference/` (the exact numbers).
...
**On the slide:** `figures/slide-06-timing-and-value.png`
...
**On the slide:** `figures/slide-07-route-region.png`, plus a channel line as text.
...
**On the slide:** `figures/slide-08-no-elbow-THE-PIVOT.png`
...
**On the slide:** `figures/slide-09-separation-ceiling.png` (or `clust_02_pca.png` for a
...
**On the slide:** `figures/slide-11-segment-results.png`
...
- [ ] Figures from `figures/` dropped into slides **in number order** and legible at the back of the room
- [ ] `02-full-study-guide.html` open in a second window for drill-downs
- [ ] `reference/segment-counts.md` open for exact segment counts
...
*Meeting pack snapshot — 13 August 2026. Source of truth is the repo: `docs/eda-results-slide-guide.md`.*
