...
OUTPUT_DIR = ROOT / "outputs" / "eda_output"
REPORT_PATH = ROOT / "reports" / "PAL_EDA_Report.html"
...
segments = [
    # ── Tier 1: Premium ──
    {
        ...
        "signals": [
            "Business cabin (J) or Economy Flex",
            "TMC / Corporate Web Portal channel",
            "Lead time 3–15 days",
            "ASEAN-dominant (SIN, BKK, HKG)",
            "Solo traveler (PAX = 1)",
        ],
    ...
    },
    {
        ...
        "signals": [
            "Active Mabuhay Miles tier (Elite/Premier)",
            "10+ flights per year on PAL",
            "Broad route coverage (not corridor-specific)",
            "Mix of business & leisure itineraries",
            "Loyalty redemption bookings",
        ],
        "benchmark": "Singapore Airlines KrisFlyer Elite — multi-segment loyalists driving disproportionate revenue share.",
        "proxy_records": "N/A",
        "proxy_pct": "Loyalty data required",
        "data_status": "blocked",
    ...
    },
    {
        ...
        "signals": [
            "Premium Economy (W) or Business (J) cabin",
            "Stay 5–14 days (longer than pure corporate)",
            "ASEAN, Australasia, Japan, Korea routes",
            "Book 7–21 days ahead",
            "Weekend departure or return",
        ],
    ...
    # ── Tier 2: PAL-Specific Philippine Market ──
    {
        ...
        "signals": [
            "Middle East corridor (RUH, DOH, DXB) or East Asia",
            "Traditional Travel Agency (TTA) dominant (59%)",
            "Economy Saver or Economy Value",
            "Lead time 30–90+ days",
            "Sea Crew sub-channel",
            "Cargo / excess baggage add-on",
        ],
    ...
    },
    {
        ...
        "signals": [
            "Beyond (INT→DOM) itinerary type (18% of dataset)",
            "Group bookings (PAX 2–6)",
            "North America or Middle East origin",
            "December–January or April travel",
            "Economy Saver, long lead time 45–90 days",
            "TTA and OTA channels",
        ],
    ...
    },
    {
        ...
        "signals": [
            "Middle East routes (Jeddah, Medina) or Europe",
            "Group bookings (parish groups, travel agencies)",
            "Seasonal: March–April or Hajj months",
            "TTA channel (parish-arranged bookings)",
            "Economy Saver, long lead (planned months ahead)",
            "Specific routing: MNL → Rome, MNL → Tel Aviv, MNL → JED",
        ],
        "benchmark": "Asia Pacific religious tourism $7.9B market (2024), growing to $23.4B by 2034 at 11.4% CAGR.",
        "proxy_records": "~400 est.",
        "proxy_pct": "~1.3% est.",
        "data_status": "partial",
    ...
    # ── Tier 3: Leisure Segments ──
    {
        ...
        "signals": [
            "PAX Count 3–5",
            "Economy Saver or Economy Value",
            "December–January, March–April, June school breaks",
            "Domestic leisure routes + short international (Japan, Korea, Bali)",
            "Book 30–60 days ahead",
            "OTA or WEB/APP channel",
        ],
        "benchmark": "Lufthansa: Care Seeking Families (6%) — all routes, all classes, leisure purpose, high service expectations.",
        "proxy_records": "~2,953 est.",
        "proxy_pct": "~9.8% est.",
        "data_status": "available",
    ...
    },
    {
        ...
        "signals": [
            "Economy Supersaver or Economy Saver",
            "MNL HUB or CEB HUB domestic dominance",
            "WEB/APP channel (promo hunters)",
            "Lead time 34+ days (median)",
            "Solo or couple (PAX 1–2)",
            "Promo fare / sale-triggered booking",
        ],
    ...
    },
    {
        ...
        "signals": [
            "Lead time 0–3 days (15.5% of dataset)",
            "Economy Flex or Business Flex farebrand",
            "Ticket Office and Contact Center channels spike",
            "All routes — not corridor-specific",
            "Higher-than-average fare per PAX (urgency premium)",
        ],
    ...
    # ── Tier 4: Emerging Segments ──
    {
        ...
        "signals": [
            "One-way or open-jaw itinerary",
            "Length of stay 14–90 days (extended stay)",
            "Economy Flex or Economy Value (flexibility needed)",
            "WEB/APP channel (tech-savvy, self-serve)",
            "ASEAN routes — BKK, CGK, DPS, SGN",
            "Solo traveler (PAX = 1)",
            "Multiple bookings on same route in short window",
        ],
        ...
        "proxy_records": "~1,200 est.",
        "proxy_pct": "~4% est. (needs LOS data)",
        "data_status": "blocked",
...
benchmarks = [
    ...
    {
        "airline": "IATA Framework",
        "model": "Trip-purpose taxonomy",
    ...
    {
        "airline": "PAL (Proposed)",
        "model": "10-segment ML model",
...
missing_features = [
    {
        "name": "Loyalty Status / Mabuhay Tier",
        "priority": "P1 — BLOCKING",
        "color": "#EF4444",
        "source": "Mabuhay Miles DB",
    ...
    {
        "name": "One-way vs. Round-trip Flag",
        "priority": "P3 — Useful",
        "color": "#60A5FA",
        "source": "Ticketed itinerary parse",
...
nl_rules = [
    {
        ...
        "outcome": "Cannot be Corporate",
        "available": 2,
        "missing": 1,
        "blocked_by": "Loyalty status",
    },
    {
        "condition": "Cargo add-on · Economy · Manila–Riyadh route",
        "outcome": "Cannot be Premium Bleisure",
        "available": 1,
        "missing": 2,
        "blocked_by": "Loyalty status, Cargo flag",
    },
    {
        "condition": "0–3 day booking · Promo fare · No flexibility",
        "outcome": "Cannot be Last-Minute Emergency",
        "available": 3,
        "missing": 0,
        "blocked_by": "—",
    },
    {
        ...
        "outcome": "Cannot be Solo Budget Leisure",
        "available": 3,
        "missing": 0,
        "blocked_by": "—",
    },
    {
        ...
        "outcome": "Corporate or Premium Bleisure only",
        "available": 1,
        "missing": 2,
        "blocked_by": "Loyalty status, Length of stay",
    },
    {
        "condition": "Middle East corridor · No Mabuhay Miles · Cargo",
        "outcome": "OFW Traveler or Balikbayan only",
        "available": 1,
        "missing": 2,
        "blocked_by": "Loyalty status, Cargo flag",
    },
    {
        ...
        "outcome": "Cannot be Budget Leisure — likely Pilgrimage",
        "available": 3,
        "missing": 0,
        "blocked_by": "—",
    },
    {
        ...
        "outcome": "Cannot be Corporate — likely Family segment",
        "available": 3,
        "missing": 0,
        "blocked_by": "—",
    },
    {
        ...
        "outcome": "Cannot be VFR — possible Digital Nomad",
        "available": 2,
        "missing": 1,
        "blocked_by": "Length of stay",
    },
]
...
charts = [
    ...
    (
        "06_ticketing_channel",
        "Booking Volume by Ticketing Channel",
    ...
    (
        "08_fare_distribution",
        "Average Fare Distribution",
    ...
    (
        "12_lead_time_by_farebrand",
        "Lead Time by Farebrand",
    ...
    (
        "15_channel_entity_heatmap",
        "Ticketing Channel × Entity Heatmap",
    ...
    (
        "16_segment_proxy_volumes",
        "Segment Proxy Record Counts",
    ...
    (
        "17_lead_time_kde_by_proxy",
        "Lead Time Distribution by Segment Proxy",
    ...
    (
        "18_fare_per_pax_by_proxy",
        "Fare per PAX by Segment Proxy",
    ...
    (
        "19_channel_by_proxy_heatmap",
        "Ticketing Channel Mix by Segment Proxy (%)",
    ...
    (
        "21_negative_learning_feasibility",
        "Negative Learning Rule Feature Coverage",
    ...
    (
        "22_missing_features_priority",
        "Recommended Missing Features — Priority Matrix",
    ...
    for tier_name, items in tiers.items():
        ...
        for s in items:
            ...
            status_html = (
                ...
                if s["data_status"] == "available"
                else '<span class="ds-badge ds-blocked">⚠ Data blocked</span>'
                if s["data_status"] == "blocked"
                else '<span class="ds-badge ds-partial">~ Partial data</span>'
            )
            out.append(f"""
...
def nl_rows():
    ...
    for r in nl_rules:
        pips = "".join(
            '<div class="nl-pip pip-ok"></div>' for _ in range(r["available"])
...
def benchmark_rows():
    ...
    for b in benchmarks:
        ...
        highlight = (
            "background:rgba(240,165,0,0.06);border-left:3px solid var(--gold);" if is_pal else ""
        )
